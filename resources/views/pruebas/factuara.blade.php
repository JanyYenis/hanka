            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 body-main">
                    <div class="col-md-12">
                       <div class="row">
                            <div class="col-md-4">
                                <i class="fas fa-cart-arrow-down icon-10x"></i>
                                {{-- <img class="img" alt="Hanka" src="http://pngimg.com/uploads/shopping_cart/shopping_cart_PNG59.png" /> --}}
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 card-body">
                                {!! QrCode::size(100)->generate('https://preview.keenthemes.com/metronic/demo1/index.html') !!}
                            </div>
                        </div>
                    </div>
                </div>
