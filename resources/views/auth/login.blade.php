    ...
    <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
        <div class="login-content d-flex flex-column pt-lg-0 pt-12">
            ...
            <div class="login-form">
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_login_singin_form" method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="pb-5 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Login</h3>
                        <div class="text-muted font-weight-bold font-size-h4">No estas registrado?
                        <a href="{{ route('register') }}" class="text-primary font-weight-bolder">Registrarme</a></div>
                    </div>
                    ...
                    <div class="form-group fv-plugins-icon-container">
                        <div class="d-flex justify-content-between mt-n5">
                            ...
                            <a href="{{ route('password.request') }}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Olvide mi contraseña</a>
                        </div>
                    ...
                    <div class="pb-lg-0 pb-5">
                        ...
                        <a type="button" href="{{url('/login-google')}}" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
